...
c.NotebookApp.mathjax_url = '/content/mathjax/MathJax.js'
...
#------------------------------------------------------------------------------
# RESTContentsManager configuration
#------------------------------------------------------------------------------

# RESTContentsManager will inherit config from: ContentsManager

# 
# c.RESTContentsManager.root_dir = u''

# The base name used when creating untitled files.
# c.RESTContentsManager.untitled_file = 'untitled'

# c.RESTContentsManager.checkpoints_class = <class 'IPython.html.services.contents.checkpoints.Checkpoints'>

# Glob patterns to hide in file and directory listings.
c.RESTContentsManager.hide_globs = [u'__pycache__', '*.pyc', '*.pyo', '.DS_Store', '*.so', '*.dylib', '*~', '.ipnb_checkpoints*']

# The base name used when creating untitled notebooks.
# c.RESTContentsManager.untitled_notebook = 'untitled'

# The base name used when creating untitled directories.
# c.RESTContentsManager.untitled_directory = 'Untitled Folder'

# 
# c.RESTContentsManager.checkpoints = None

# 
# c.RESTContentsManager.checkpoints_kwargs = {}
...
#c.NotebookApp.login_handler_class = Handler

try:
    import bleach_whitelist

    c.Exporter.preprocessors.append('nbconvert.preprocessors.sanitize.SanitizeHTML')
    c.SanitizeHTML.attributes = bleach_whitelist.print_attrs
    c.SanitizeHTML.styles = bleach_whitelist.all_styles
    c.SanitizeHTML.tags = bleach_whitelist.generally_xss_safe
except:
    # When running jupyter commands different environments
    # can pick this up w/o bleach_whitelist installed
    pass

c.NotebookApp.allow_origin = 'https://notebooks.azure.com'
c.NotebookApp.base_url = 'nb/'
c.NotebookApp.tornado_settings = {'static_url_prefix':'/Scripts/jupyter/5.5.0/'}
c.NotebookApp.token = ''
